...
const PasswordResetSuccess = lazy(
  () => import("@/pages/auth/PasswordResetSuccess.jsx"),
);
const CandidateDashboard = lazy(
  () => import("@/pages/candidate/CandidateDashboard.jsx"),
);
const ProfileSetup = lazy(() => import("@/pages/candidate/ProfileSetup.jsx"));
const InterviewConfiguration = lazy(
  () => import("@/pages/candidate/InterviewConfiguration.jsx"),
);
const InterviewSession = lazy(
  () => import("@/pages/interview/InterviewSession.jsx"),
);
const ResumeUpload = lazy(() => import("@/pages/interview/ResumeUpload.jsx"));
const EvaluationResult = lazy(
  () => import("@/pages/results/EvaluationResult.jsx"),
);
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<RoleBasedRoute allowedRoles={[ROLES.CANDIDATE]} />}>
            <Route element={<DashboardLayout />}>
              <Route
                path="/candidate"
                element={<Navigate to={ROUTES.CANDIDATE_DASHBOARD} replace />}
              />
              <Route
              ...
              <Route
                path={ROUTES.INTERVIEW_CONFIGURATION}
                element={<InterviewConfiguration />}
              />
              <Route
                path={ROUTES.INTERVIEW_SESSION}
                element={<InterviewSession />}
              />
              <Route path={ROUTES.RESUME_UPLOAD} element={<ResumeUpload />} />
              <Route
                path={ROUTES.EVALUATION_RESULT}
                element={<EvaluationResult />}
              />
              <Route
                path={ROUTES.FEEDBACK_REPORT}
